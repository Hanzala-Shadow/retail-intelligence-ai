...
Usage:
    python src/sec_downloader.py                  # process all pending
    python src/sec_downloader.py --limit 10        # first 10 pending only
    python src/sec_downloader.py --retry-failed     # also retry failed rows
    python src/sec_downloader.py --no-drive         # download only, skip Drive upload
