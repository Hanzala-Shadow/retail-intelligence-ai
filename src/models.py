...
    sustainability_reports = relationship(
...
    _tablename_ = "sustainability_reports"
...
        "Company",
        back_populates="sustainability_reports"
    )
