...
Usage:
    python src/sec_discovery.py
    python src/sec_discovery.py --limit 5      # test on first 5 companies only
    python src/sec_discovery.py --ticker GPS   # test a single company
"""
