...
def automatic_decision(
    ...
    structural_risk = bool(metrics["two_column_candidate"]) and (
        int(metrics["mixed_column_lines"]) >= MIN_MIXED_COLUMN_LINES
        or coverage_disagreement
    )
    missing_text = (
