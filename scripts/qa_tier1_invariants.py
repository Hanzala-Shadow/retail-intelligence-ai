...
Usage
    python scripts/qa_tier1_invariants.py
    python scripts/qa_tier1_invariants.py --checks 1,2,3
    python scripts/qa_tier1_invariants.py --json-out reports/qa_tier1.json
"""
