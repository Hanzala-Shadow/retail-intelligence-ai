"""Run the ESG VLM stages: page classification and table extraction.
    ...
    python scripts/run_esg_vlm.py classify --transport sync|batch [--wait] [--limit N]
    python scripts/run_esg_vlm.py extract  --transport sync|batch [--wait] [--limit N]
    python scripts/run_esg_vlm.py collect            # collect any finished batches
    python scripts/run_esg_vlm.py status
