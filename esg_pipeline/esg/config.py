...
SUSTAINABILITY_INTERIM_DIR = INTERIM_DIR / "sustainability"
# Stages 1-2 are expensive reusable cache. Keep their files separate from the
# bridge's document layout so a clean section/chunk rebuild never removes them.
DOCLING_LAYOUT_DIR = SUSTAINABILITY_INTERIM_DIR / "01_docling_layout"
DOCLING_FUSED_PAGES_DIR = SUSTAINABILITY_INTERIM_DIR / "02_esg_text"
DOCLING_FUSED_SUMMARY_JSON = SUSTAINABILITY_INTERIM_DIR / "fused_summary.json"
ESG_TEXT_DIR = SUSTAINABILITY_INTERIM_DIR / "03_pipeline_text"
OCR_STAGING_DIR = INTERIM_DIR / "ocr_staging"
ESG_SECTIONS_DIR = SECTIONS_DIR / "sustainability"
ESG_CHUNKS_DIR = CHUNKS_DIR / "sustainability"
...
# The Docling fusion bridge reads ESG_PARSE_INDEX_CSV for source identity and
# writes its extraction results here. These paths must never be the same.
ESG_PARSE_INDEX_V2_CSV = REFERENCE_DIR / "esg_parse_index_v2.csv"  # noqa: F405
