...
ways at once: it arrived carrying paths rooted at another machine's
``C:/Users/<name>/.../Retail-Document-Intelligence`` profile, and the bridge
was itself writing absolute paths against whichever checkout produced the run.
