...
HUMAN_SCORES = config.REPORTS_DIR / "old_vs_new_review_2026-07-30" / "recovered_scores_unblinded.json"
HUMAN_SOURCE_COMPARISON = config.REPORTS_DIR / "parser_comparison_2026-07-30" / "parser_comparison.json"
SEED = 20260730
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out-dir", type=Path, default=config.REPORTS_DIR / f"llm_reader_review_{DEFAULT_DATE}")
