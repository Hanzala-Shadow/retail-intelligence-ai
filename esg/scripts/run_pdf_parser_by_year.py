"""Run esg/src/pdf_parser.py scoped to PDFs whose report year matches a target set.
...
The year of a multi-year stem is the canonical report year from esg/src/esg_year.py:
