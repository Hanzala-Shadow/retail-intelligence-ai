...
Usage:
    python esg/src/drive_downloader.py --resume
    python esg/src/drive_downloader.py --ticker GAP --force
    python esg/src/drive_downloader.py --dry-run
"""
...
# OAuth flow lives in common/drive_auth.py -- shared with count_drive_pdfs.py
# (ESG) and drive_uploader.py (10-K), which sit on the other side of the split.
