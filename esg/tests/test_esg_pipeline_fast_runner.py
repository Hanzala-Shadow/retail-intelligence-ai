...
RUNNER = REPO_ROOT / "esg" / "scripts" / "run_esg_pipeline_fast.ps1"
...
class ESGFastPipelineRunnerTests(unittest.TestCase):
    def test_default_all_order_includes_manifest(self) -> None:
        ...
        self.assertIn("esg/scripts/build_esg_vector_manifest.py", output)
    ...
    def test_default_all_never_starts_paid_vlm_work(self) -> None:
        ...
        self.assertNotIn("esg/scripts/run_esg_vlm.py", output)
